  ...
  Functions: {
    Console: {
      ...
      SetCR: function( C , R ){
        ...
        Saxan.Functions.Display.StyleElements()
        },
      },
    Display: {
      ...
      MainDisplayFunctions: function(){
        ...
        Saxan.Functions.Display.CountDisplay()
        Saxan.Functions.Display.CountVisible()
        Saxan.Functions.Display.RowsAndColumns()
        Saxan.Functions.Display.StyleElements()
        },
    ...
    Events: {
      OnChange: function(){
        ...
        Saxan.Functions.Display.MainDisplayFunctions()
        },
      ...
      OnLevelClick: function(){
        switch( event.button ){
          case 0 :
            ...
            break
          case 1 :
            Saxan.Functions.Display.HideAllShows()
          ...
          case 'Advanced' :
            switch( event.button ){
              case 0 :
                ...
                switch( true ){
                  case event.ctrlKey :
                    Saxan.Functions.Display.ShowLinks( this )
                    break
                  case ( Saxan.Globals.ClickInfo.Time2 - Saxan.Globals.ClickInfo.Time1 ) < 250 && Saxan.Globals.ClickInfo.Elem1 == Saxan.Globals.ClickInfo.Elem2 :
                    ...
                    Saxan.Functions.Display.PermanentItemToggle( this.id )
                    Saxan.Functions.Display.MainDisplayFunctions()
                    break
      ...
      OnStart: function(){
        Saxan.Functions.Initialization.CheckLocalStorage()
        Saxan.Functions.Initialization.DeclareStyleSheet()
        Saxan.Functions.Initialization.CreateInputs()
        Saxan.Functions.Initialization.CreateShowList()
        Saxan.Functions.Events.OnChange()
        },
      },
    Initialization: {
      ...
      CreateInputs: function(){
        ...
        var B
          ...
          B.onmousedown = Saxan.Functions.Events.OnConfigureClick
          A.appendChild( B )
        for( var i = 0 ; i < Saxan.Globals.ShowInfo.Levels.length && Saxan.Globals.ShowInfo.Levels.length > 1 ; i++ ){
          ...
          B.onmousedown = Saxan.Functions.Events.OnLevelClick
          A.appendChild( B )
          }
        },
      CreateShowList: function(){
        ...
        for( var a = 0 ; a < Saxan.Globals.ShowList.length ; a++ ){
          ...
          Show.onmousedown         = Saxan.Functions.Events.OnShowClick
