...
// Display
  ...
  function ShowLinks( Show ){
    var T = '<div class="Title" onclick="window.open( \'https://www.google.com/search?q=' + Show.id.replace( / /g , '+' ).toHyperLink() + '\' )" >' + Show.id + '</div>'
    var M = '\
...
// Initialization
  ...
  function CreateShowList(){
    var B  = document.getElementById( 'Shows' ),
      ...
      nE = '',
      sM = 'http://watch-tv-series.to/serie/',
      sB = 'http://watch-tv-series.to/search/',
      sE = '',
